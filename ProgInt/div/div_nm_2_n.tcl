...
for {set N 2} {$N < 65} {incr N} {
	for {set M 2} {$M < 65} {incr M} {
		...
		read_verilog -overwrite -defer -sv  div_nm_2_n.sv
		hierarchy -check -top div_nm_2_n -chparam N $N -chparam M $M 
		...
		write_verilog -noattr -noexpr -nohex syn/div_${N}_${M}_${N}bit.v
	}
}